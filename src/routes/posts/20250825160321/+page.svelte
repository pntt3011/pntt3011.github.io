...
<img class="image-box" loading="lazy" src="/media/Pasted_image_20250820224531.png" alt="" width="999" height="1024" style="max-width: 80%; max-height: 70vh; width: auto; height: auto; margin-left: auto; margin-right: auto;"/>
<p>(Source: <a href="https://doi.org/10.3389/fnana.2021.693346">https://doi.org/10.3389/fnana.2021.693346</a>)</p>
...
<img class="image-box" loading="lazy" src="/media/Pasted_image_20250823102906.png" alt="" width="1024" height="484" style="max-width: 80%; max-height: 70vh; width: auto; height: auto; margin-left: auto; margin-right: auto;"/>
<p>(The star distribution is for demonstration purposes only. The real distribution is much more complex and has much higher dimensions that we can't easily visualize.)</p>
...
<p>Wait a second, earlier I said I needed to find the distribution of real-world data. But after drawing the picture above, isn't it more reasonable to discover the distribution of the choices instead? That seems to be the direct &quot;internal force&quot; that guides unordered states into our world. The real world we observe is simply a product of this force.</p>
...
<img class="image-box" loading="lazy" src="/media/Pasted_image_20250823181718.png" alt="" width="300" height="168" style="max-width: 80%; max-height: 70vh; width: auto; height: auto; margin-left: auto; margin-right: auto;"/>
<p>(3D Perlin Noise visualization, <a href="https://www.scratchapixel.com/lessons/procedural-generation-virtual-worlds/perlin-noise-part-2/perlin-noise-terrain-mesh.html">source</a>)</p>
...
<p>As you can see, the “Quantum choice” component is the key element in this framework. At the end of the day, I have resolved to pursue a higher degree in Quantum Mechanics to further deepen my knowledge in this field.</p>
