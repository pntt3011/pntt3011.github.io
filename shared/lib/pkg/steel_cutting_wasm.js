 ...
 * @returns {any}
 */
export function compute_cutting_plan_numeric(input) {
    const ret = wasm.compute_cutting_plan_numeric(input);
    if (ret[2]) {
 ...
 * @returns {any}
 */
export function compute_optimal_stock_cutting_plan_numeric(input) {
    const ret = wasm.compute_optimal_stock_cutting_plan_numeric(input);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
